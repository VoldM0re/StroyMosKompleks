...
<head>
    ...
    <title>СтройМосКомплекс - Строительные работы</title>
    <meta name='description' content='Строительные работы - услуги и возможности, которые мы предлагаем'>
...
<body>
    ...
    <main>
        <section class='services_cards-wrapper container'>
            ...
            listServices('Строительные работы', 'construction'); ?>
        </section>
    </main>
