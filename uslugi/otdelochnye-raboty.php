...
<head>
    ...
    <title>СтройМосКомплекс - Отделочные работы</title>
    <meta name='description' content='Отделочные работы - услуги и возможности, которые мы предлагаем'>
...
<body>
    ...
    <main>
        <section class='services_cards-wrapper container'>
            ...
            listServices('Отделочные работы', 'finishing'); ?>
        </section>
    </main>
